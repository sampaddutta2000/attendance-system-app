...
hostname = 'redis-12471.c267.us-east-1-4.ec2.cloud.redislabs.com'
portnumber = '12471'
password = '3tJBjA6jreDbA6SbYCqIgTT3QG9o23We'
...
class RealTimePred:
    ...
    def face_prediction(self,test_image, dataframe, feature_column, 
        ...
        #step 2 use for loop and extract each embedding and pass to ml_seaml_search_algorithm
